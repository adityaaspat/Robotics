...
class mppi_working:
    ...
    def make_trajectories(self):
        ...
        delta_actions_v = np.random.uniform(low=0, high=0.22, size=(self.num_of_trajectories, self.horizon,1))
        delta_actions_w=np.random.uniform(low=-2, high=2, size=(self.num_of_trajectories, self.horizon,1))                                    
    ...
    def calculate_costs(self):
            ...
            for i in range(self.num_of_trajectories):
                ...
                for j in range(self.horizon):
                    ...
                    if int(self.map_data[linear_index])== 100:
